...
class TreasuresControllerTest < ActionController::TestCase
  ...
  test "should create treasure" do
    assert_difference('Treasure.count') do
      post :create, treasure: { description: @treasure.description, level: @treasure.level, quantity: @treasure.quantity, quantity_assigned: @treasure.quantity_assigned }
    end
  ...
  test "should update treasure" do
    put :update, id: @treasure, treasure: { description: @treasure.description, level: @treasure.level, quantity: @treasure.quantity, quantity_assigned: @treasure.quantity_assigned }
    assert_redirected_to treasure_path(assigns(:treasure))
  end
